...
<html class="no-js h-100" lang="en">
  <head>
    ...
    <title>Codeigniter CMS</title>
    <meta name="description" content="A high-quality &amp; free Bootstrap admin dashboard template pack that comes with lots of templates and components.">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <link href="<?php echo base_url() ?>assets/styles/all.css" rel="stylesheet">
    <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/styles/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
    ...
    <script async defer src="<?php echo base_url() ?>assets/scripts/buttons.js"></script>
     <link rel="stylesheet" href="<?php echo base_url() ?>assets/styles/quill.snow.css">
  </head>
  <body class="h-100">
